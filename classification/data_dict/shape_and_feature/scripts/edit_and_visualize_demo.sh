...
'pix2pixHD')
  ...
  64)
    ...
    PARAM_K=256
    CLF_EPOCH=120
    DATASET_DIR='FashionPlus/datasets/'
...
############### UPDATE AND GENERATE  ###############
exec_options="python FashionPlus/classification/data_dict/shape_and_feature/update_demo.py \
...
python FashionPlus/postprocess/process_face.py \
